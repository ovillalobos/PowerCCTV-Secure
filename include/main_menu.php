<a href="principal.php?mod=well" class="logo">
	<span class="logo-mini"><img src="img/logo-sm.png" width="40" /></span>
	<span class="logo-lg"><img src="img/logo.png" width="140" /></span>
</a>
	...
	<div class="navbar-custom-menu">
		<ul class="nav navbar-nav">
					...
					<li>
						<ul class="menu">
							<li>
								<a href="#">
									<div class="pull-left">
										<img src="img/employe/user2-160x160.jpg" class="img-circle" alt="User Image">
									</div>
									<h4>Support Team<small><i class="fa fa-clock-o"></i> 12:15:00</small></h4>
			...
			<li class="dropdown user user-menu">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					<img src="img/employe/user2-160x160.jpg" class="user-image" alt="User Image">
					<span class="hidden-xs">Edgar</span>
				</a>
				<ul class="dropdown-menu">
					<li class="user-header">
						<img src="img/employe/user2-160x160.jpg" class="img-circle" alt="User Image">
						<p>
							Edgar - Manager<small>Online</small>
						</p>
					</li>
